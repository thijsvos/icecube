...
/// The SMC commands Zephyr uses, passed in `SMCParamStruct.data8`.
///
/// Write (6) is listed for completeness but has **no caller in ZephyrKit** —
...
/// Power-limit block (16 bytes). Unused by Zephyr, but part of the wire layout.
